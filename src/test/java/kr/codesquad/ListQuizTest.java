...
class ListQuizTest {
    ...
    public void arrayList() throws Exception {
        ...
        assertEquals("first", values.getFirst()); // TODO 9 첫 번째 값을 찾아라.
        assertTrue(values.contains("first")); // TODO 10 "first" 값이 포함되어 있는지를 확인
        assertEquals("first", values.removeFirst()); // TODO 11 첫 번째 값을 삭제해라.
        assertEquals(-1, values.indexOf("first")); // TODO 12 11에서 삭제한 값이 삭제 됐는지 확인한다.
